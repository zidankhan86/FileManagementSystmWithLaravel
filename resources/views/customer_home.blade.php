...
<head>
    ...
    <link href="{{ url('adminlte/bootstrap/css/bootstrap.css') }}" rel="stylesheet">
...
{{--    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">--}}
    ...
    <link href="{{ url('adminlte/css/customer.css') }}" rel="stylesheet">
...
{{--                        </div>--}}
                        ...
                        <div class="custom-dropdown">
                            ...
                            <div class="custom-dropdown-content">
                                   <div class="text-c"> <a href="#">Option 1</a> </div>
