...
@section('content')
    <h3 class="page-title">
        @lang('quickadmin.users.title')</h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="#folders" aria-controls="folders" role="tab"
                        data-toggle="tab">Folders</a></li>
                {{-- <li role="presentation" class=""><a href="#files" aria-controls="files" role="tab"
                                ...
                                @foreach ($files as $file)
                                    <tr data-entry-id="{{ $file->id }}">
                                        ...
                                        <td field-key='filename'>
                                            @if ($file->filename)
                                                <a href="{{ asset(env('UPLOAD_PATH') . '/' . $file->filename) }}"
